<?php include ('header2.php'); ?>
			...
			<div id="slides" class="carousel slide" data-ride="carousel">
				...
				<div class="main" id="main">
					...
					<h5>What we offer</h5>
					<p>Our platform www.fasttextng.com is developed so as to offer you opportunity to send SMS to multiple contacts . Below are the benefits you enjoy from </p>
