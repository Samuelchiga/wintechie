...
<body>
	<div class="container"  style="background-color: #f9fbfc">
		<header><nav id="ken" class="navbar navbar-expand-md sticky-top">
				...
				<div class="container-fluid" >
					...
					<div class="collapse navbar-collapse" id="navbarresponsive">
						<ul id="bar" class="navbar-nav ml-auto">
							<li class="nav-item">
								<a href="Homepage.php" class="btn  active">Home</a>
							</li>
							<li class="nav-item">
								<a href="HowItWork.php"  style="background-color: #052146; color: white" class="btn ">How it works</a>
							</li>
							<li class="nav-item">
			...
			<div id="slides" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
					<div class="carousel-item active"><img src="img/image7.jpg"  width="100%" height="400px" >
						<div class="carousel-caption" style="margin-bottom: 60px;">
							...
							<a href="register.php"><button type="button"  class="btn btn-outline-light btn-lg">REGISTER NOW</button></a>
							<a href="Homepage.php"><button type="button"  class="btn btn-outline-light btn-lg">SIGN IN</button></a>
						</div>
					</div>
					...
					<div class="carousel-item"><img src="img/image2.jpg" width="100%"  height="400px" >
						<div class="carousel-caption" style="margin-bottom: 60px;">
							...
							<h2> THE BEST BULK AND CHEAPEST SMS EVER</h2>
							<h4 class="lead">TECHSMS is a provider of a text group messaging solutions.</h4>
						</div>

				<section class="section1"  style="">
					
					<h2 class="lead"><i class="fas fa-user "></i>  Extremely Easy</h2>
					<p>TECHSMS allows you to send an unlimited number of messages to multiple recipients in a few simple steps. It is engaging and easy to use web-based text messaging solutions. <br> 

						* Register free at http://www.smsafricang.com with a valid Email address <br>
						* Sign in to SMS Africa with your email and password <br>
				...
				<section class="section3">
					...
					<h2 class="lead"><i class="fas fa-user "></i> Incredibly Fast</h2>
					<p>TECHSMS messaging service is very fast. In other words, you're just a click away from your target group <br>

						* Register free at http://www.smsafricang.com with a valid Email address <br>
						* Sign in to SMS Africa with your email and password. <br>
						* Connect to  friends via TECHSMS.
					</p>
				...
				<section class="section5">
					...
					<h2 class="lead"><i class="fas fa-user "></i>Unbelievably Effective</h2>
					<p>98% of all Sms messages are read immediately! In addition, the costs are low and the return on investment is quite high <br>

						* Register free at http://www.smsafricang.com with a valid Email address <br>
						* Sign in to SMS Africa with your email and password. <br>
						* You can now sms at a cheaper rate.
					</p>
	...
	section.section2{
		background: url(img/adult-beautiful-caucasian-914931.jpg);
...
section.section4{
		background: url(img/adult-business-comfort-920382.jpg);
		background-size: cover;
		background-attachment: fixed; 
		opacity: 0.7;
	}
