		...
		<header><nav id="ken" class="navbar navbar-expand-md sticky-top">
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="navbarresponsive">
						<ul id="bar" class="navbar-nav ml-auto">
							...
							<li class="nav-item">
								<a href="ContactUs.php" style="background-color: #052146; color: white"  class="btn ">contact Us</a>
							</li>
			...
			<div id="slides" class="carousel slide" data-ride="carousel">
				...
				<div class="main" id="main">
					...
					<h3>hey dude!! <br> im yet to be updated <br>please try and update contact us</h3>
